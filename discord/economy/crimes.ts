...
export const CRIME_DEFINITIONS: CrimeDefinition[] = [
  { id: "pickpocket", name: "Pickpocket", successRate: 80, rewardMin: 20, rewardMax: 80, fineMin: 10, fineMax: 30, cooldownMs: 30 * 60_000 },
  { id: "shoplifting", name: "Shoplifting", successRate: 65, rewardMin: 50, rewardMax: 200, fineMin: 30, fineMax: 80, cooldownMs: 45 * 60_000 },
  { id: "carjacking", name: "Carjacking", successRate: 50, rewardMin: 150, rewardMax: 500, fineMin: 80, fineMax: 200, cooldownMs: 60 * 60_000 },
  { id: "bank-robbery", name: "Bank Robbery", successRate: 35, rewardMin: 400, rewardMax: 1200, fineMin: 200, fineMax: 500, cooldownMs: 90 * 60_000 },
  { id: "heist", name: "Heist", successRate: 20, rewardMin: 1000, rewardMax: 5000, fineMin: 500, fineMax: 2000, cooldownMs: 120 * 60_000 },
];
